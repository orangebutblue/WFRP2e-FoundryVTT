export default class RollDialog extends Dialog {
    ...
    updateValues(html) {
        ...
        if (!game.settings.get("wfrp2e", "mooAdvantage"))
            html.find('[name="testModifier"]')[0].value = Number(html.find('[name="testModifier"]')[0].value) + (game.settings.get("wfrp2e", "advantageBonus") * this.advantage || 0) || 0
        ...
        difficultySelect.val(game.wfrp2e.utility.alterDifficulty(this.userEntry.difficulty, this.cumulativeBonuses.difficultyStep || 0))
    }
    ...
    activateListeners(html) {
        ...
        this.userEntry.testModifier = Number(html.find('[name="testModifier"]').change(ev => {
            ...
            if (!game.settings.get("wfrp2e", "mooAdvantage"))
                this.userEntry.testModifier -= (game.settings.get("wfrp2e", "advantageBonus") * this.advantage || 0) || 0
        ...
        if (!game.settings.get("wfrp2e", "mooAdvantage"))
            this.userEntry.testModifier -= (game.settings.get("wfrp2e", "advantageBonus") * this.advantage || 0)
