...
export default class StatBlockParser extends FormApplication {
    static get defaultOptions() {
        ...
        options.template = "systems/wfrp2e/templates/apps/stat-parser.html";
        options.height = 600;
        options.width = 600;
    ...
    static async parseStatBlock(statString, type = "npc") {
        ...
        for (let trapping of trappingStrings) {
            ...
            if (!trappingItem) {
                trappingItem = new ItemWfrp2e({ img: "systems/wfrp2e/icons/blank.png", name: trapping, type: "trapping", data: game.system.model.Item.trapping })
